    ...
    public class DArticulo
    {
        ...
        public DataTable Buscar(string valor)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("articulo_buscar", SqlCon); // Create the SqlCommand object to execute the stored procedure
        ...
        public string Insertar(Articulo obj) // Insert method to add a new Categoria record, is using the model Categoria from Categoria.cs
        {
