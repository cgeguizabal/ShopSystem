    ...
    public partial class FrmCliente : Form
    {
        ...
        private void Listar() //Method to list users
        {
            try
            {
                ...
                DgvListado.DataSource = NPersona.ListarClientes(); //Call to the business layer to get the list of users
        ...
        private void Buscar() //Method to search users
        {
            try
            {
                ...
                DgvListado.DataSource = NPersona.BuscarClientes(TxtBuscar.Text); //Call to the business layer to search users based on the text in TxtBuscar
